...
The packages in the `depthai` repository were released into the `jazzy` distro by running `/root/venv/bin/bloom-release -r jazzy depthai --override-release-repository-push-url git@github.com:revyos-ros/depthai-core-release.git` on `Mon, 23 Jun 2025 08:01:51 -0000`
...
- release repository: https://github.com/revyos-ros/depthai-core-release.git
...
## depthai (jazzy) - 2.29.0-1

The packages in the `depthai` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy depthai --override-release-repository-push-url git@github.com:revyos-ros/depthai-core-release.git` on `Fri, 17 Jan 2025 06:49:20 -0000`
...
The packages in the `depthai` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble depthai --override-release-repository-push-url git@github.com:revyos-ros/depthai-core-release.git` on `Thu, 16 Jan 2025 16:25:20 -0000`
...
The packages in the `depthai` repository were released into the `jazzy` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r jazzy depthai --override-release-repository-push-url git@github.com:revyos-ros/depthai-core-release.git` on `Thu, 19 Dec 2024 11:36:04 -0000`
...
The packages in the `depthai` repository were released into the `humble` distro by running `/home/z572/gits/revyos-ros/venv2/bin/bloom-release -r humble depthai --override-release-repository-push-url git@github.com:revyos-ros/depthai-core-release.git` on `Mon, 23 Sep 2024 14:39:14 -0000`
...
The packages in the `depthai` repository were released into the `humble` distro by running `/usr/bin/bloom-release depthai --rosdistro humble` on `Thu, 07 Mar 2024 07:55:22 -0000`
